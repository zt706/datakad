...
<body class="colorTipContainer" onload="update()" bgcolor = "#FFFFFF">
<style type="text/css"> 
  ...
  <div id="main"><div class="main-t">   
     <div id="l_sidebar" class="l-sidebar">
     	<ul class="c-menu"><li class="c-menu-seperator c-menu-seperator-none" style="border: none;"></li>
     						<li class="c-menu-select">    <a style="padding-top:20px;height:16px" href="/servlet/Target?type=1" rel="live" rname="第一时间">第一时间</a></li>
     						...
     						<li class="has-children">    <a href="/servlet/Target?type=2" rname="热销品牌排行榜" class="children-show">商品效能分析</a>
     							<ul class="c-menu-children">
     								<li param="tabs8" class="">    <a href="#" rname="热销品牌排行榜"></a></li>
     								<li param="tabs5" class="">    <a href="#" rname="整体情况"></a></li>
     							</ul></li>
     						<li class="c-menu-seperator"></li>
     						<li class="has-children">    <a href="/servlet/Target?type=3" rname="产品热销排行" class="children-show">流量分析</a>
     							<ul class="c-menu-children">
     								<li class="">    <a href="#" rel="prod_hot" rname="产品热销排行"></a></li>
     								<li param="tabs6" class="">    <a href="#" rname="整体情况"></a></li>
     							</ul></li>
     						<li class="c-menu-seperator"></li>
     						<li class="has-children">    <a href="/servlet/Target?type=4" rname="属性组合排行" class="children-show">seo关键词排名</a>
     							<ul class="c-menu-children">
     						...
     						<li class="c-menu-seperator"></li>
     						<li class="has-children">    <a href="/servlet/Target?type=5" rname="行业关键词热搜TOP榜" class="children-show">热词分析</a>
     							<ul class="c-menu-children">
...
<div id="foot" class="cb-f">Copyright 2014-<span class="copyrightEnd">2015</span>,版权所有data.360kad.com</div>
